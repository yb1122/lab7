...
public class NotificationHelper {
    ...
    public final String CHANNEL_ID = "channel_chat";
    ...
    public void showNotification(Context context, int id){
        ...
        PendingIntent replyPendIntent =
                PendingIntent.getBroadcast(context, item.getId(), replyIntent, PendingIntent.FLAG_MUTABLE | PendingIntent.FLAG_UPDATE_CURRENT);

        NotificationCompat.Action action =
                new NotificationCompat.Action.Builder(R.drawable.ic_reply_icon,
                        context.getString(R.string.reply), replyPendIntent)
